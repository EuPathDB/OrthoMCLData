package OrthoMCLData::Load::Plugin::InsertCoreOrthoGroups;
...
sub undoPreprocess {                                                                                                                                                                                         my ($self, $dbh, $rowAlgInvocationList) = @_;                                                                                                                                                         
  my $sql = "DELETE FROM apidb.orthologgroup WHERE IS_RESIDUAL = 0";                                                                                                                                         
