...
[
    fileArg({name           => 'orthoFile',
            descr          => 'Ortholog Data. OrthologGroupName followed by the ids for the members of the group',
            reqd           => 1,
            mustExist      => 1,
            format         => 'OG0000000ccin-old|CC1G_04709, ccin-old|CC1G_04741, ccin-old|CC1G_06911',
...
my $purpose = <<PURPOSE;
Insert an ApiDB::OrthoGroups and its members from an orthomcl groups file.
PURPOSE
